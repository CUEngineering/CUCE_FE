    ...
    <div class="registrar-header">
      <div class="registrar-info">
        <div class="name-status-wrapper">
          <h3 class="registrar-name">{{ selectedCourse.name }}</h3>
        </div>
        <div class="status-badge" :class="statusClass">
          <span class="status-dot"></span>
          {{ capitalizeFirst(selectedCourse.type) }}
        </div>
      </div>
    ...
    <div class="registrar-stats">
      ...
      <div class="stat-group">
        ...
        <div class="stat-item">
          ...
          <div class="stat-value">{{ selectedCourse.courses }}</div>
        </div>
      </div>
      <div class="stat-group">
        <div class="stat-divider"></div>
        <div class="stat-item">
          ...
          <div class="stat-value">{{ selectedCourse.credits }}</div>
        </div>
      </div>
    </div>
  </div>
...
const statusClass = computed(() => {
  switch (props.selectedCourse.type.toLowerCase()) {
    case "undergraduate":
